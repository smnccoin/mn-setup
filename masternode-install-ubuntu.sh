...
COIN_TGZP='https://github.com/smnccoin/smnc/releases/download/v1000/SMNC-Linux-1000.zip'
COIN_BOOTSTRAP='https://github.com/smnccoin/smnc/releases/download/v1000/Bootstrap.zip'
