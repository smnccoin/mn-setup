...
COIN_TGZP='https://github.com/smnccoin/smnc/releases/download/v2000/smnc-linux-daemon.zip'
COIN_BOOTSTRAP='https://github.com/smnccoin/smnc/releases/download/v2000/Bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='smnc'
COIN_NAME_OLD='smncd'
PROJECT_NAME='SIMPLEMASTERNODE (SMNC)'
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/smnc-general-info

cat << EOF > /root/smnc-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/smnc-fee-info

cat << EOF > /root/smnc-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Network Info: ${NC}"
$COIN_CLI getnetworkinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/smnc-networkinfo

cat << EOF > /root/smnc-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/smnc-masternode-stats
...
echo -e "alias smncinfo='/root/smnc-general-info'" >> /root/.bashrc
echo -e "alias feestats='/root/smnc-fee-info'" >> /root/.bashrc
echo -e "alias networkstats='/root/smnc-networkinfo'" >> /root/.bashrc
echo -e "alias mnstats='/root/smnc-masternode-stats'" >> /root/.bashrc
exec bash
}
...
function important_information() {
 ...
 echo -e "You can also use ${RED}smnc-cli getinfo${NC}, ${RED}smnc-cli getnetworkinfo${NC}, ${RED}smnc-cli getconnectioncount${NC}commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
